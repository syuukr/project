...
# iptables -t mangle -I PREROUTING -p tcp --dport 22 -m state --state NEW -m recent --set
# iptables -t mangle -I PREROUTING -p tcp --dport 22 -m state --state NEW -m recent --update --seconds 60 --hitcount 20 -j DROP
